...
class Doll {
	constructor() {
		loader.load("/models/Squid-Doll/scene.gltf", (gltf) => {
...
class Player {
	constructor() {
		const geometry = new THREE.SphereGeometry(0.3, 32, 16); //radius, height, width
	...
	update() {
		...
		this.player.position.x -= this.playerInfo.velocity;
	}
}
